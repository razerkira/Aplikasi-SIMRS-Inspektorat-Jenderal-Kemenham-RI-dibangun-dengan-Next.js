// src/components/SupabaseUploadIzinCutiForm.tsx
"use client";
...
export default function SupabaseUploadIzinCutiForm() {
  ...
  const cutiOptions = [
    "Tahunan", "Sakit", "Alasan Penting", "Besar",
    "Diluar Tanggungan Negara", "Bersalin", "Lainnya..."
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => { router.push("/izin-cuti"); }, 2000);
                      ...
                      {cutiOptions.map((option) => (
                        <CommandItem
                          ...
                          onSelect={(currentValue: string) => {
                            // Logika onSelect dibuat lebih robust
